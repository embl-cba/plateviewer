...
public class MultiResolutionChannelSource< R extends RealType< R > > implements Source< R >
{
	private final HashMap< Double, RandomAccessibleInterval< R > > scaleToRai;

	public MultiResolutionChannelSource( HashMap< Double, RandomAccessibleInterval< R > > scaleToRai )
	{
