...
public abstract class MultiWellFilteredCachedCellImage< T extends RealType< T > & NativeType< T > > extends MultiWellCachedCellImage< T >
{
	...
	public MultiWellFilteredCachedCellImage( List< File > files, String namingScheme, int numIoThreads )
	{
		this( files, namingScheme, numIoThreads, null, null );
	}

	public MultiWellFilteredCachedCellImage( List< File > files, String namingScheme, int numIoThreads, String channelName )
	{
		this( files, namingScheme, numIoThreads, channelName, null );
	}

	public MultiWellFilteredCachedCellImage( List< File > files, String namingScheme, int numIoThreads, String channelName, int resolutionLevel )
	{
		this.files = files;
