...
//		if ( fontSize < 8 ) return;
	 ...
	 */
	public static class BehaviourTransformEventHandlerPlanar implements BehaviourTransformEventHandler< AffineTransform3D >
	{
		...
		/**
		 * Current baseImagesSource to screen transform.
		 */
