...
public class FastFilters implements ExtendedPlugInFilter, DialogListener {
	...
	public final static int MEAN=0, BORDER_LIMITED_MEAN=1, MEDIAN=2, MIN=3, MAX=4;   //"elementary" filter types
	 ...
	 */
	public void filterFloat(ImageProcessor ip, final int type, final int radius, boolean xDirection,
